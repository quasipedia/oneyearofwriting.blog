...
In 2007, Dr. Gail Matthews set out to experimentally investigate the claim made by this myth. Her [study](https://scholar.dominican.edu/cgi/viewcontent.cgi?article=1002&context=psychology-faculty-conference-presentations) showed that writing goals combined with public commitment and accountability significantly increase the likelihood of follow-through.

While my primary aim with _One Year of Writing (OYW)_ is squarely to provide useful writing on _leadership_ and _technology_, I also want it to be a public case study in building a _writing_ habit and craft. So - armed with the knowledge from Matthews' work - I decided to pursue my objective of posting weekly throughout 2026, by applying the suggestions in the study. Expect evidence-informed reflections, practical tools, and honest progress reports (including failures).
...
{{< article link="/misc/of-explorers-and-scientists/" showSummary=true compactSummary=true >}}
...
It is with this mindset that I have started _One Year of Writing_. It is the appeal of an adventure, the lure of “going where no _Mac_ has gone before”[^1] that got me started.
...
- **Domain-specific knowledge**. I am a man of many interests, but for OYW, I limited my focus to two themes: _leadership_ and _technology_. I expect the first to be mostly dedicated to better structure my mental models around leadership (a field in which I have experience in), and the second to mostly revolve around _AI safety_ (an entirely new topic for me). My hypothesis is that - with a bit of support from Madame Curie - I will be able to turn experiences and ideas into a cohesive lattice of mental models (i.e.: knowledge) for both themes. I am still unsure how to measure progress.
...
[^1]: Those who I expected to understand, understood! 🖖

[^2]: I shall emphasise the _premature_ part here, meaning that it's not simply _early_ in the process, but _too early_, thus leading to a lot of waste, as I will very often remove entire sections of my text that I had spent valuable time "optimising".
